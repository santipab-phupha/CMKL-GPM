...
st.title("จำลองการกระจาย (Gaussian Plume Model) บนแผนที่กรุงเทพฯ : เน้นสีส้ม")

st.markdown("""
**วิธีใช้งาน:**
1. คลิกบนแผนที่ด้านล่างเพื่อระบุจุด "ระเบิด"  
2. ปรับค่าพารามิเตอร์ Gaussian (Q, u, t, wind direction, sigma, max range ฯลฯ) ใน Sidebar  
3. HeatMap จะแสดงโดยไล่สี "เหลือง→ส้ม→แดง" โดยเน้นให้เห็นส้มมากขึ้น  
   - ถ้าสีแดงยังเยอะไป สามารถลดค่า Q หรือลดค่า Sigma เพื่อให้ค่าความเข้มไม่สูงไปทั่วบริเวณ
""")
